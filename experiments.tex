...
tasks. \figref{fig:drawerimgs} shows intermediate steps and belief
states for the drawer task. The included video demonstrates plan execution all three tasks.

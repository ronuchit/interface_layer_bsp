...
observations. We refer to the first component as positive
...
negative observation region. The inverse probability is given by $\max(1,\frac{\text{penetration distance}}{\text{object radius}})$, where object radius is found by approximating the object as a sphere.
...
\begin{table}
  ...
  \begin{tabular}{cccc}
    \toprule
      Problem Type & \% Solved in 1800s & Avg Solution Time(s) & Avg \# Planner Runs\\
    \midrule
